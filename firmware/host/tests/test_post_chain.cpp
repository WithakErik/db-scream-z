...
int main() {
  ...
  // ---- tone: dark attenuates highs, bright boosts them, center flat
  {
    ...
    dark.set(-1.0f, 1.0f, 1.0f, 1.0f);
    flat.set(0.0f, 1.0f, 1.0f, 1.0f);
    bright.set(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    PostChain dark2(sr);
    dark2.set(-1.0f, 1.0f, 1.0f, 1.0f);
    float lo_dark = sine_rms(dark2, 100.0f, sr);
    PostChain flat2(sr);
    flat2.set(0.0f, 1.0f, 1.0f, 1.0f);
